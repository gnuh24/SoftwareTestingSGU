...
INSERT INTO `Product` (`Id`, `ProductName`, 						`Status`, 		`CreateTime`, 			`Image`, 							`Price`, 	`Origin`, 		`Capacity`, 	`ABV`, 		`Quantity`, 	`Description`, 					`BrandId`, `CategoryId`) VALUES
						(1, 'HaKu Vodka', 							TRUE, 			'2024-07-03 10:00:00', 'haku-vodka.png', 					150000, 	'Japan',		 	700, 			40, 		50, 		'A smooth Japanese vodka.', 		2, 				2),
						(2, 'HaNoi VodKa', 							TRUE, 			'2024-07-02 10:00:00', 'hanoi-vodka.png', 					200000, 	'Vietnam', 			500, 			39, 		100, 		'Classic Vietnamese vodka.', 		3, 				2),
						(3, 'Beluga Noble', 						TRUE, 			'2024-07-02 10:00:00', 'beluga-noble.png', 					350000, 	'Russia', 			700,			40, 		30, 		'Premium Russian vodka.', 			4, 				2),
						(4, 'Grey Goose', 							TRUE, 			'2024-07-02 10:00:00', 'grey-goose.png', 					450000, 	'France', 			750, 			40, 		20, 		'French luxury vodka.', 			5, 				2),
						(5, 'Beluga Allure', 						TRUE, 			'2024-07-02 10:00:00', 'beluga-allure.png', 				500000, 	'Russia', 			700, 			40, 		15, 		'Luxurious Russian vodka.', 		4, 				2),
						(6, 'King Robert', 							TRUE, 			'2024-07-02 10:00:00', 'king-robert.png', 					250000, 	'Scotland', 		750, 			43, 		25, 		'Strong Scottish vodka.', 			2, 				2),
						(7, 'Smirnoff Red Vodka', 					TRUE, 			'2024-07-02 10:00:00', 'smirnoff-red.png', 					180000, 	'USA', 				750, 			37, 		50, 		'Popular American vodka.',			5, 				2),
						(8, 'Stolichnaya Vodka',					TRUE, 			'2024-07-02 10:00:00', 'stolichnaya-vodka.png', 			220000, 	'Russia', 			700, 			38, 		40, 		'Famous Russian vodka.',			6, 				2),
						(9, 'Vodka Danzka', 						TRUE, 			'2024-07-02 10:00:00', 'vodka-danzka.png', 					280000, 	'Denmark', 			700, 			40, 		30, 		'Danish vodka.', 					7, 				2),
						(10, "Glen'S Platinum", 					TRUE, 			'2024-07-02 10:00:00', 'glens-platinum.png', 				320000, 	'Scotland', 		700,			40, 		35, 		'Scottish vodka.', 					8, 				2),

						-- Tequila products
						(11, 'Tequila Clase Azul Reposado', 		TRUE, 			'2024-07-03 11:00:00', 'clase-azul-reposado.png', 			800000, 	'Mexico', 			750,			40, 		20, 		'Premium Reposado Tequila.', 		9, 				3),
						(12, 'Don Julio 1942', 						TRUE, 			'2024-07-03 11:00:00', 'don-julio-1942.png', 				1200000, 	'Mexico', 			750, 			40, 		10, 		'Luxury Añejo Tequila.', 			10, 			3),
						(13, 'Patrón Silver', 						TRUE, 			'2024-07-03 11:00:00', 'patron-silver.png',					700000, 	'Mexico',			750, 			40, 		25, 		'Smooth Silver Tequila.', 			11, 			3),
						(14, 'Maestro Dobel Diamante', 				TRUE, 			'2024-07-03 11:00:00', 'maestro-dobel-diamante.png', 		900000, 	'Mexico', 			750,			40, 		18, 		'Premium Cristalino Tequila.', 		12, 			3),
						(15, 'Gran Centenario Plata', 				TRUE, 			'2024-07-03 11:00:00', 'gran-centenario-plata.png', 		600000, 	'Mexico', 			750, 			40, 		22, 		'Smooth Plata Tequila.', 			13, 			3),
						(16, 'Tequila 1800 Añejo', 					TRUE, 			'2024-07-03 11:00:00', 'tequila-1800-anejo.png', 			1000000, 	'Mexico', 			750, 			40, 		15, 		'Aged Añejo Tequila.', 				14, 			3),
						(17, 'Tequila Clase Azul Plata', 			TRUE, 			'2024-07-03 11:00:00', 'clase-azul-plata.png', 				850000, 	'Mexico', 			750, 			40, 		20,		 	'Premium Plata Tequila.', 			9, 				3),
						(18, 'Don Julio Blanco', 					TRUE, 			'2024-07-03 11:00:00', 'don-julio-blanco.png', 				950000, 	'Mexico', 			750, 			40, 		12, 		'Smooth Blanco Tequila.', 			10, 			3),
						(19, 'Patrón Añejo', 						TRUE, 			'2024-07-03 11:00:00', 'patron-anejo.png',					1100000, 	'Mexico', 			750, 			40, 		10, 		'Rich Añejo Tequila.', 				11, 			3),
						(20, 'Tequila 1800 Silver', 				TRUE, 			'2024-07-03 11:00:00', 'tequila-1800-silver.png',			650000, 	'Mexico', 			750, 			40, 		25, 		'Popular Silver Tequila.', 			14, 			3),

						-- Wishkey products from Johnnie Walker
						(21, 'Johnnie Walker Red Label', 			TRUE, 			'2024-07-03 12:00:00', 'johnnie-walker-red.png', 			450000, 	'Scotland', 		750, 			40, 		50, 		'Iconic Red Label Wishkey.', 		15, 			4),
						(22, 'Johnnie Walker Black Label', 			TRUE, 			'2024-07-03 12:00:00', 'johnnie-walker-black.png', 			650000, 	'Scotland', 		750, 			40, 		40, 		'Classic Black Label Wishkey.', 	15, 			4),
						(23, 'Johnnie Walker Double Black', 		TRUE, 			'2024-07-03 12:00:00', 'johnnie-walker-double-black.png', 	750000, 	'Scotland', 		750, 			40, 		30, 		'Smokier Double Black Wishkey.', 	15, 			4),
						(24, 'Johnnie Walker Gold Label Reserve', 	TRUE, 			'2024-07-03 12:00:00', 'johnnie-walker-gold.png', 			900000, 	'Scotland', 		750, 			40, 		20, 		'Luxurious Gold Label Wishkey.', 	15, 			4),
						(25, 'Johnnie Walker Green Label', 			TRUE, 			'2024-07-03 12:00:00', 'johnnie-walker-green.png',			 850000, 	'Scotland', 		750, 			40, 		15, 		'Smooth Green Label Wishkey.', 		15, 			4),
						(26, 'Johnnie Walker Platinum Label', 		TRUE, 			'2024-07-03 12:00:00', 'johnnie-walker-platinum.png', 		1200000, 	'Scotland', 		750,			40, 		10, 		'Exclusive Platinum Label Wishkey.',15, 			4),
						(27, 'Johnnie Walker Blue Label', 			TRUE, 			'2024-07-03 12:00:00', 'johnnie-walker-blue.png', 			2500000, 	'Scotland', 		750, 			40, 		5, 			'Rare Blue Label Wishkey.', 		15, 			4),
						(28, 'Johnnie Walker Gold Label 18', 		TRUE,			'2024-07-03 12:00:00', 'johnnie-walker-gold-18.png', 		1350000, 	'Scotland', 		750, 			40, 		12, 		'Aged 18 Years Wishkey.', 			15, 			4),
						(29, 'Johnnie Walker Green Label 15', 		TRUE, 			'2024-07-03 12:00:00', 'johnnie-walker-green-15.png', 		1100000, 	'Scotland', 		750,			40, 		8, 			'15-Year-Old Wishkey.', 			15, 			4),
						(30, 'Johnnie Walker King George V',		TRUE, 			'2024-07-03 12:00:00', 'johnnie-walker-king-george.png', 	3500000, 	'Scotland', 		750,			40, 		3, 			'Exclusive King George V Wishkey.', 15, 			4);
...
INSERT INTO `OrderStatus` (`OrderId`, `Status`, `UpdateTime`) VALUES
						...
						('ORD00000005', 'DangGiao', '2024-07-06 12:00:00'),
						('ORD00000005', 'GiaoThanhCong', '2024-07-06 14:00:00'),

						('ORD00000006', 'ChoDuyet', '2024-07-06 10:31:00'),
						('ORD00000006', 'DaDuyet', '2024-07-06 11:00:00'),
						('ORD00000006', 'DangGiao', '2024-07-06 13:00:00'),
						('ORD00000006', 'GiaoThanhCong', '2024-07-06 15:00:00'),

						('ORD00000007', 'ChoDuyet', '2024-07-06 11:16:00'),
						('ORD00000007', 'DaDuyet', '2024-07-06 11:30:00'),
						('ORD00000007', 'DangGiao', '2024-07-06 13:30:00'),
						('ORD00000007', 'GiaoThanhCong', '2024-07-06 16:00:00'),
