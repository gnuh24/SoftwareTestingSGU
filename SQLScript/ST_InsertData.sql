...
INSERT INTO `Product` (`Id`, `ProductName`, 						`Status`, 		`CreateTime`, 			`Image`, 							`Price`, 	`Origin`, 		`Capacity`, 	`ABV`, 		`Quantity`, 	`Description`, 					`BrandId`, `CategoryId`) VALUES
						...
						(6, 'King Robert', 							TRUE, 			'2024-07-02 10:00:00', 'SoftwareTestingProject/kingRobert', 					250000, 	'Scotland', 		750, 			43, 		25, 		'Strong Scottish vodka.', 			2, 				2),
						...
						(14, 'Maestro Dobel Diamante', 				TRUE, 			'2024-07-03 11:00:00', 'SoftwareTestingProject/maestroDobel', 		900000, 	'Mexico', 			750,			40, 		18, 		'Premium Cristalino Tequila.', 		12, 			3),
						...
						(24, 'Johnnie Walker Gold Label Reserve', 	TRUE, 			'2024-07-03 12:00:00', 'SoftwareTestingProject/johnnieWalkerGold', 			900000, 	'Scotland', 		750, 			40, 		20, 		'Luxurious Gold Label Wishkey.', 	15, 			4),
						...
						(28, 'Johnnie Walker Gold Label 18', 		TRUE,			'2024-07-03 12:00:00', 'SoftwareTestingProject/johnnieWalkerGold18', 		1350000, 	'Scotland', 		750, 			40, 		12, 		'Aged 18 Years Wishkey.', 			15, 			4),
